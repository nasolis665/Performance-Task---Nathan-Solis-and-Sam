...
def fight():
  ...
  print("%s's Health %d/%d  %s's Health: %i/%i" %
        (PlayerIG.name, PlayerIG.health, PlayerIG.maxhealth, enemy.name,
...
def inventory():
  ...
  if option == "1":
    ...
    if (option2 == "steel sword") and ("Steel Sword" in PlayerIG.inventory):
      ...
      option = input(" ")
      inventory()
    elif (option2 == "diamond sword") and ("Diamon Sword"
                                           in PlayerIG.inventory):
      os.system('clear')
      ...
      option = input(" ")
      inventory()
    elif (option2 == "steel armour") and ("Steel Armour"
                                          in PlayerIG.inventory):
      os.system('clear')
      ...
      option = input(" ")
      inventory()
    elif (option2 == "diamond armour") and ("Diamond Armour"
                                            in PlayerIG.inventory):
      os.system('clear')
